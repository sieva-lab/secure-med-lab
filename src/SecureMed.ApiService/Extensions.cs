...
namespace SecureMed.ApiService;
    ...
    extension(WebApplicationBuilder builder)
    {
        public WebApplicationBuilder AddAuthentication()
        {
            builder.Services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme)
                .AddKeycloakJwtBearer(
                    ...
                    {
                        options.Audience = "secure-med.api";
            ...
            builder.Services.AddOpenApi(openApi =>
            {
                openApi.AddDocumentTransformer((document, _, _) =>
                {
                    ...
                    document.Info = new OpenApiInfo
                    {
                        ...
                        Version = "v1",
                        Description = "This is a sample API for the SecureMed project.",
        ...
        public WebApplicationBuilder AddWolverine()
        {
            ...
            builder.Host.UseWolverine(opts =>
            {
                ...
                var connectionString = builder.Configuration.GetConnectionString("securemed-db") ?? throw new InvalidOperationException("Connection string 'securemed-db' not found.");
