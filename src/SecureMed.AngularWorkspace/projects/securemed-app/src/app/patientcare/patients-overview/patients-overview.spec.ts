...
import { type PatientOverviewResponse } from '@securemed-app/patientcare/models';
import { TestBed } from '@angular/core/testing';
import { stripUtilAttributes } from '@securemed-app/test/test-utils';
import PatientsOverview from '@securemed-app/patientcare/patients-overview/patients-overview';


it('renders the component with patients table', async () => {
	const mockPatients: PatientOverviewResponse[] = [
	...
	await mockRequest(mockPatients);
...
async function setup() {
	const { fixture, container } = await render(PatientsOverview, {
