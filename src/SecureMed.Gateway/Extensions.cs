...
using SecureMed.Gateway.Transformers;
using Yarp.ReverseProxy.Transforms;

namespace SecureMed.Gateway;
    ...
    extension(IHostApplicationBuilder builder)
    {
        ...
        public IHostApplicationBuilder AddAuthenticationSchemes()
        {
            builder.Services.AddAuthentication(options =>
                ...
                {
                    options.Cookie.Name = "SecureMed.Gateway.Auth";
                ...
                .AddKeycloakOpenIdConnect(
                    ...
                    {
                        options.ClientId = "securemed-gateway";
                        ...
                        options.Scope.Add("securemed:all");
        ...
        // Add rate limiting based on user identity or IP address for anonymous users
